...
public class SnowmanPanel extends JPanel{
  ...
  public void paintComponent (Graphics page)
  {
    ...
    page.fillOval (MID - 7, TOP + 40, 14, 14); // top button
    page.fillOval (MID - 7, TOP + 60, 14, 14); // bottom button
    
    page.setColor (Color.black);
    page.fillOval (MID - 10, TOP + 10, 5, 5);   // left eye
    page.fillOval (MID + 5, TOP + 10, 5, 5);    // right eye
    
    page.drawArc (MID - 10, TOP + 22, 20, 12, 358, 184);   // smile
    ...
    page.drawString("Shaun Liew",10, 12);
  }
}
